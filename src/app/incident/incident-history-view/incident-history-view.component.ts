...
store:'',
significantOthers:'',},redactRuleData:{} };
...
insuranceVerificationViewData:any={ incidentForm: {},
formFieldAccess: {},
toolTipData: {},}
...
console.log(this.formFieldAccess,"this.formFieldAccess");
...
parantsContactNo: data.injuredParentsContactNo.toString(),
...
this.personalInfoView.showData = {isRedacted:this.isRedacted,
...
this.issuesHandlingViewData.showData = {formType:this.incidentSelectedTypeData.name,
...
this.insuranceVerificationData.showData={isRedacted:this.isRedacted,severityInfo:this.incidentEditData.severityInfo,
...
let showBasicData = {isRedacted:this.isRedacted,
...
let insuranceShow=this.incidentService.isLegalInfoViewAccess(this.formFieldAccess);
...
let param = {"incidentId":(this.incidentEditData.incidentStatus=='Draft')?this.incidentEditData.id:this.incidentEditData.incidentId,
